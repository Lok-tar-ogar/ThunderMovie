...
class FILM(models.Model):
    ...
    download_link=models.CharField('下载链接-来自kanxi.cc',max_length=5000,null=True)
    download_link2 = models.CharField('下载链接2-来自ygdy8.net', max_length=500, null=True)
    download_link3 = models.CharField('下载链接3', max_length=500, null=True)
    download_link4=models.TextField('下载链接4-来自btbtdy.com',null=True)
...
class TVSERIES(models.Model):
    ...
    download_link2 = models.TextField('下载链接2-来自btbtdy.com', null=True)
